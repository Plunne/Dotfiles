...
- 1. Clone this repo and go to =plunne_dotfiles= directory.
#+begin_src shell
git clone https://gitlab.com/Plunne/plunne_dotfiles ~/.gitlab/plunne_dotfiles
cd .gitlab/plunne_dotfiles
#+end_src
