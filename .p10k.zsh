...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$bg_color
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$fg_color
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$fg_color
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$bg_color
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$fg_color
