...
-- Bar
theme.bg_bar    = "#ffffff00"--theme.color_lighter
...
theme.fg_modules_icon   = theme.color_white
...
theme.titlebar_bg_focus     = theme.color_white
theme.titlebar_fg_normal    = theme.color03
theme.titlebar_bg_normal    = theme.color_white
