...
-- Bar
theme.bg_bar    = "#ffffff"--theme.color_lighter
...
theme.bg_minimize   = theme.color_light
...
theme.bg_modules        = theme.color_white
theme.bg_modules_icon   = theme.color_light
theme.fg_modules_icon   = theme.color01
theme.bg_modules_text   = theme.bg_modules
theme.fg_modules_text   = theme.fg_modules_icon
...
theme.bg_modules_date       = theme.color_cherry--bg_modules_icon
theme.bg_modules_date_icon  = theme.color_cherry--bg_modules_icon
theme.fg_modules_date_icon  = theme.bg_bar--fg_modules_icon
theme.bg_modules_date_text  = theme.bg_bar--bg_modules_text
...
theme.bg_modules_memory         = theme.color_cyan--bg_modules_icon
theme.bg_modules_memory_icon    = theme.color_cyan--bg_modules_icon
theme.fg_modules_memory_icon    = theme.bg_bar--fg_modules_icon
theme.bg_modules_memory_text    = theme.bg_bar--bg_modules_text
...
theme.bg_modules_volume         = theme.color_olive--bg_modules_icon
theme.bg_modules_volume_icon    = theme.color_olive--bg_modules_icon
theme.fg_modules_volume_icon    = theme.bg_bar--fg_modules_icon
theme.bg_modules_volume_text    = theme.bg_bar--bg_modules_text
theme.fg_modules_volume_text    = theme.color_olive

-- Taglist
theme.taglist_font          = theme.fontname .. 12
theme.taglist_bg            = theme.bg_modules_icon
theme.taglist_fg_focus      = theme.fg_modules_text
theme.taglist_bg_focus      = theme.bg_modules_text
theme.taglist_fg_occupied   = theme.fg_modules_icon
theme.taglist_bg_occupied   = theme.bg_modules_icon
...
theme.tasklist_bg           = theme.bg_modules_icon
theme.tasklist_fg_focus     = theme.fg_modules_text
theme.tasklist_bg_focus     = theme.bg_modules_text
theme.tasklist_fg_normal    = theme.fg_modules_text
theme.tasklist_bg_normal    = theme.bg_bar
theme.tasklist_fg_minimize  = theme.color_lighter
theme.tasklist_bg_minimize  = theme.bg_bar
theme.tasklist_fg_urgent    = theme.color01
...
theme.tasklist_shape_border_color           = theme.bg_bar
theme.tasklist_shape_border_color_focus     = theme.bg_modules_icon
theme.tasklist_shape_border_color_minimized = theme.bg_bar
